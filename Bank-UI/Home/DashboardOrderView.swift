...
class DashboardOrderView: UIView {
    
    let mainView = UIView()
    
    let amoungView = UIView()
    let saleLabel = makeLabel(withText: "Orders", fontSize: 0, fontColor: .black, fontBold: 18)
    let totalSaleLabel = makeLabel(withText: "Total Order Today", fontSize: 0, fontColor: .lightGray, fontBold: 10)
    let amoungLabel = makeLabel(withText: "1900", fontSize: 0, fontColor: .black, fontBold: 25)
    
    let percentageCircleView = UIView()
    let percentageLabel = makeLabel(withText: "80%", fontSize: 0, fontColor: .black, fontBold: 20)
    ...
    func style(){
        ...
        percentageCircleView.backgroundColor = .darkBlue
